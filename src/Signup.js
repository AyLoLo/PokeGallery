    ...
    return (
        <div>
            <div>    
                ...
                <form className="lg:flex justify-center bg-[url('https://i.pinimg.com/originals/ee/52/86/ee5286dd15598789e61ed4f01ee3ba25.jpg')] bg-no-repeat bg-fixed bg-center min-h-screen" onSubmit={handleSubmit}>
                        <div className="bg-yellow-400 border-red-950 md:border-4 h-40">
                            ...
                            <button className="text-red-950 lg:flex items-center" type="submit">Signup</button>
                        </div>
                 </form>
        </div>
    );
